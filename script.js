function startExperience() {
    ...
    // Iniciar generación de flores
    setInterval(createFlower, 1000);  // Nuevas flores cada segundo (puedes ajustar a 3000 para cada 3 segundos)
}

document.getElementById('startButton').addEventListener('click', function() {
    startExperience();
    // Ocultar botón después de presionar
